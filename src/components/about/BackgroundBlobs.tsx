...
const BackgroundBlobs = () => {
  return (
    <div className="absolute top-0 left-0 w-full h-full opacity-20 overflow-hidden pointer-events-none">
      ...
      <div className="absolute bottom-1/3 left-1/4 w-48 h-48 rounded-full bg-gradient-to-r from-green-300 to-teal-400 blur-3xl animate-blob" style={{ animationDelay: "6s" }}></div>
    </div>
  );
};
