...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* SEO Enhancements */}
      <Helmet>
        <title>Ambica Pharma - Leading Pharmaceutical Distributor & Exporter</title>
        <meta name="description" content="Ambica Pharma trades and exports high-quality pharmaceutical products, serving 25+ countries with 1000+ medicines across therapeutic categories since 2005." />
        <meta name="keywords" content="pharmaceutical distributor, Ambica Pharma, medicine exporter, pharmaceutical trader, healthcare, tablets, capsules, injectables, WHO-GMP, ISO 9001" />
          ...
          {`
            {
              ...
              "foundingDate": "2005",
              "description": "Leading pharmaceutical distributor, trader, and exporter with WHO-GMP certification, serving global markets since 2005.",
              "address": {
                "@type": "PostalAddress",
        ...
        <div className="container relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div 
              ...
              className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all border border-blue-100 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-blue-100 to-transparent rounded-bl-full"></div>
              <motion.div 
                className="w-14 h-14 bg-blue-50 rounded-full flex items-center justify-center mb-6 text-blue-600 relative z-10"
              ...
              <h3 className="text-xl font-bold text-blue-700 mb-3">Business Type</h3>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              whileHover={{ y: -10, transition: { duration: 0.3 } }}
              className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all border border-indigo-100 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-indigo-100 to-transparent rounded-bl-full"></div>
              <motion.div 
                className="w-14 h-14 bg-indigo-50 rounded-full flex items-center justify-center mb-6 text-indigo-600 relative z-10"
                whileHover={{ rotate: -5, scale: 1.1 }}
                transition={{ type: "spring", stiffness: 300, damping: 10 }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-xl font-bold text-indigo-700 mb-3">Year of Establishment</h3>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              whileHover={{ y: -10, transition: { duration: 0.3 } }}
              className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all border border-violet-100 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-violet-100 to-transparent rounded-bl-full"></div>
              <motion.div 
                className="w-14 h-14 bg-violet-50 rounded-full flex items-center justify-center mb-6 text-violet-600 relative z-10"
                whileHover={{ rotate: 5, scale: 1.1 }}
                transition={{ type: "spring", stiffness: 300, damping: 10 }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-xl font-bold text-violet-700 mb-3">Experience</h3>
          ...
          >
            {globalAchievements.map((item, index) => (
              <motion.div
                ...
                className="bg-white/90 backdrop-blur-sm p-4 md:p-6 rounded-lg shadow-lg border border-blue-100 text-center transform transition-transform"
              >
                <motion.div 
      ...
      <section className="py-16 bg-gradient-to-b from-white to-blue-50 dark:from-background dark:to-indigo-900/10 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-40 left-20 w-64 h-64 bg-blue-100/40 rounded-full filter blur-3xl"></div>
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-indigo-100/40 rounded-full filter blur-3xl"></div>
        </div>
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {productCategories.map((category, index) => (
              ...
              >
                <Card className="bg-white border border-blue-100 shadow-lg h-full overflow-hidden relative">
                  <div className="h-2 bg-gradient-to-r from-blue-500 to-indigo-500"></div>
                  <CardContent className="p-4 md:p-6 h-full flex flex-col">
                    <motion.div 
                      className="bg-gradient-to-br from-blue-50 to-indigo-50 p-3 md:p-4 rounded-full w-16 h-16 md:w-20 md:h-20 flex items-center justify-center mx-auto mb-3 md:mb-4"
                      whileHover={{ rotate: 5, scale: 1.1 }}
                      transition={{ type: "spring", stiffness: 300, damping: 10 }}
                    >
                      {category.icon}
                    </motion.div>
                    <h3 className="text-lg md:text-xl font-bold text-blue-700 text-center mb-2">{category.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, transition: { duration: 0.3 } }}
                className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg bg-white/90 backdrop-blur-sm shadow-md hover:shadow-xl transition-all border border-blue-100 group"
              >
                <motion.div 
                ...
                <h3 className="font-semibold text-blue-700 text-lg md:text-xl mb-2">{item.title}</h3>
      ...
      <section className="py-16 bg-gradient-to-b from-blue-50 to-white dark:from-indigo-900/10 dark:to-background relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-100/50 rounded-full filter blur-3xl opacity-70 animate-blob" style={{ animationDuration: "15s" }}></div>
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-indigo-100/50 rounded-full filter blur-3xl opacity-70 animate-blob" style={{ animationDuration: "20s", animationDelay: "2s" }}></div>
        </div>
              ...
              {customerTestimonials.map((testimonial, index) => (
                <CarouselItem key={index} className="sm:basis-1/1 md:basis-1/2 lg:basis-1/3 p-1">
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <Card className="bg-white border border-blue-100 shadow-md hover:shadow-lg transition-all h-full overflow-hidden group">
                      <div className="h-2 bg-gradient-to-r from-blue-500 to-indigo-500"></div>
                      <CardContent className="p-6 h-full flex flex-col">
                        <motion.div 
                          className="mb-4 text-indigo-600 transition-transform duration-300"
                          whileHover={{ rotate: 5, scale: 1.1 }}
                          transition={{ type: "spring", stiffness: 300, damping: 10 }}
                        >
                        ...
                        <p className="text-foreground/70 text-center italic mb-6 relative">
                          <span className="text-blue-300 text-3xl absolute -top-2 -left-1 opacity-20">"</span>
                          {testimonial.quote}
                          <span className="text-blue-300 text-3xl absolute -bottom-4 -right-1 opacity-20">"</span>
                        </p>
